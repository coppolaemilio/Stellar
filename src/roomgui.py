...
class RoomGUI(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.toolbar = QtGui.QToolBar('Rooms Toolbar')
    ...
    def onChanged(self, text):
        ...
        os.rename(os.path.join(self.dirname, "Rooms", str(self.FileName)) + ".py",
                  os.path.join(self.dirname, "Rooms", finalname))
    ...
    def exportScript(self):
        ...
        fname = os.path.join(self.dirname, "Rooms", str(self.FileName))+ ".py"
